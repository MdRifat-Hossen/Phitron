...
int main()
{
    ...
    while (true)
    {
        cout << "Option 1:insert a value" << endl;//done
        cout << "Option 2:print a value" << endl;//done
        cout << "Option 3:insert any Possition" << endl;//dode;
        cout << "Option 4: Isert at head" << endl;//done;
        cout << "Option 5:Delete from possiton " << endl;//done;
